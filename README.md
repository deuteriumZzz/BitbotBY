...
```
1.  Сканирует монеты на Bybit (futures): bluechip-профиль → топ-20 из BLUECHIP_BASES, altcoin → топ-50 не-bluechip монет
...
MIN_SIGNAL_CONFIDENCE=0.65        # Минимальная уверенность сигнала в live режиме (0–1).
...
| **Монеты** | Топ-20 из BLUECHIP_BASES (BTC, ETH, SOL, XRP, BNB…) | Топ-50 по объёму, исключая BLUECHIP_BASES, фильтр $500K–$2B |
| **Таймфрейм** | 15m | 5m |
| **Риск/сделку** | 2% | 1% |
...
|---|---|---|---|
| Порог сигнала | 0.60 | 0.65 | `.env` / Telegram ⚖️ Риск |
