...
> |---------|--------|------------------------|-----------------------------|
> | Bluechip | `models/sac_model.zip` | `models/best_hyperparams_bluechip.json` | `data/experiences_bluechip.jsonl` |
...
Во время обучения можно проверить статус в реальном времени через Telegram:
...
Кнопка **🔄 Обновить** подтягивает актуальные данные. Когда обучение не запущено — кнопка сообщает об этом. Бот продолжает торговать во время обучения.
