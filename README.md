...
| Когда | Действие | Как |
|-------|----------|-----|
| Первый запуск | Обучить SAC | Кнопка в Telegram или `make train` |
| Постоянно | Дообучение на сделках | Автоматически (OnlineLearner) |
| Через 60+ дней | Тюнинг + полное обучение | Кнопка 🔬 в Настройках или `make tune && make train` |
