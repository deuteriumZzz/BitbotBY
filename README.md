...
```
1.  Сканирует монеты на Bybit (futures): bluechip-профиль → динамический топ-20 по объёму, altcoin → динамический топ-100 (без пересечения с текущим топ-20)
...
7.  Выбирает до 3 лучших рекомендаций по composite score (confidence × потенциал × объём × режим)
