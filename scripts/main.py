...
class TradingBot:
    ...
    async def _restore_state(self):
        ...
        if balance_state:
            self.current_balance = balance_state.get('current_balance', Config.INITIAL_BALANCE)
    ...
    async def _execute_trade(self, signal: dict, market_data: pd.DataFrame):
        ...
        try:
            ...
            if order:
                ...
                self.redis.save_trading_state('balance', {
    ...
    async def _update_performance_stats(self):
        ...
        try:
            stats = {
                'timestamp': datetime.now().isoformat(),
                'current_balance': self.current_balance,
                'profit_loss': (self.current_balance - Config.INITIAL_BALANCE) / Config.INITIAL_BALANCE * 100,
