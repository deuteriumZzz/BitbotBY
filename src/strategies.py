...
class TradingStrategy:
    ...
    def _generate_signal(self, data: pd.DataFrame, current_state: Dict) -> Dict[str, Any]:
    ...
    def _ema_crossover_strategy(self, data: pd.DataFrame, current_state: Dict) -> Dict[str, Any]:
    ...
    def _rsi_momentum_strategy(self, data: pd.DataFrame, current_state: Dict) -> Dict[str, Any]:
