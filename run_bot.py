...
from utils.logger import LoggerAdapter, logger
...
class CryptoTradingBot:
    def __init__(self, config: Config):
        ...
        self.logger = LoggerAdapter(
            logger, {"component": "main", "mode": config.TRADING_MODE}
        )
...
async def main():
    ...
    parser.add_argument(
        "--interval", type=int, default=60, help="Trading interval in seconds"
    )
